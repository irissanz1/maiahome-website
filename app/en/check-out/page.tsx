...
export const metadata: Metadata = {
  ...
  description:
    "Maia Home departure guide: check-out times and what to check before you leave (windows, appliances, front door).",
  alternates: { canonical: "/en/check-out", languages: { es: "/check-out", en: "/en/check-out" } },
...
const POINTS = [
  ...
  ["Turn off all appliances", "Especially the electric heater, the air conditioning and the lights."],
  ["Close the front door firmly", "To lock it, press the latch with the palm of your hand until you hear a click."],
];

export default function CheckOut() {
  return (
    <div className="mx-auto max-w-4xl px-5 py-14 md:py-16">
      <p className="text-xs font-semibold uppercase tracking-[0.25em] text-maia-strong">Before you leave</p>
      ...
      <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-3">
        <div className="rounded-2xl border border-neutral-200 p-5">
          <p className="text-xs font-medium uppercase tracking-wide text-neutral-500">Check-out · CDMX</p>
          <p className="mt-1 text-2xl font-bold text-neutral-900">Until 12:00</p>
          <p className="mt-1 text-xs text-neutral-500">Polanco and Condesa.</p>
        </div>
        <div className="rounded-2xl border border-neutral-200 p-5">
      ...
      <section className="mt-10 rounded-2xl bg-[#FBF7EC] p-6 md:p-8">
        ...
        <div className="mt-4 flex flex-wrap gap-3">
          <a
            href={whatsappUrl("Hi, I have a question about the check-out for my Maia Home booking.")}
            target="_blank"
