...
export default async function Reservar({
  ...
  return (
    <div className="mx-auto max-w-6xl px-5 py-8">
      ...
      <h1 className="mt-4 font-serif text-3xl font-bold text-neutral-900 md:text-4xl">Completa tu reserva</h1>
      ...
      <div className="mt-6 grid grid-cols-1 gap-8 lg:grid-cols-[1fr_320px]">
        ...
        <aside className="h-fit space-y-4 lg:sticky lg:top-24">
          ...
          <a
            href={whatsappUrl(`Hola, necesito ayuda con mi reserva de ${p.nombre}.`)}
            target="_blank"
            rel="noopener noreferrer"
            className="block rounded-2xl border border-neutral-200 p-5 transition hover:border-maia-strong"
          >
            <p className="text-sm font-semibold text-neutral-900">¿Necesitas ayuda?</p>
            <p className="mt-0.5 text-xs text-neutral-500">Escríbenos por WhatsApp {WHATSAPP_DISPLAY} y te asistimos.</p>
          </a>
        </aside>
      </div>
