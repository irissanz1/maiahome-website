      ...
      {zonaBlog.length > 0 && (
        <section className="mx-auto max-w-6xl px-5 py-14">
          <h2 className="font-serif text-2xl text-neutral-900 md:text-3xl">
            Guías de {zona.nombre}
          </h2>
          <p className="mt-2 text-neutral-600">
            Qué hacer, dónde comer y qué ver alrededor de tu departamento.
          </p>
            ...
            {zonaBlog.map((post) => (
              ...
              >
                ...
                <div className="flex flex-1 flex-col p-5">
                  ...
                  <span className="mt-3 text-sm font-semibold text-maia-strong">Leer más →</span>
                </div>
              </Link>
            ))}
          </div>
          <Link href="/blog" className="mt-8 inline-block text-sm font-semibold text-maia-strong underline">
