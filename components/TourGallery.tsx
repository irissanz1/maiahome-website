...
export type Tour = { nombre: string; specs: string; url: string };
    ...
    <>
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {tours.map((t) => (
          ...
          >
            <div className="relative flex aspect-[4/3] items-center justify-center bg-gradient-to-br from-neutral-800 to-neutral-600">
              <span className="flex h-14 w-14 items-center justify-center rounded-full bg-white/90 text-neutral-900 transition group-hover:scale-110">
