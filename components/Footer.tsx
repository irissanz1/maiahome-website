          ...
          <div className="max-w-sm">
            ...
            <div className="mt-5 flex items-center gap-3">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Facebook de Maia Home"
                className="flex h-9 w-9 items-center justify-center rounded-full border border-neutral-700 text-neutral-300 transition hover:border-maia-yellow hover:text-maia-yellow"
              >
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M13.5 21v-8h2.7l.4-3.1h-3.1V7.9c0-.9.25-1.5 1.5-1.5h1.6V3.6c-.3 0-1.25-.1-2.35-.1-2.3 0-3.9 1.4-3.9 4v2.3H7.8V13h2.65v8h3.05Z" /></svg>
              </a>
              <a
